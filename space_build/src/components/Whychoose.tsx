...
export default function WhyChooseVasteriorPage() {
  return (
    <div className="min-h-screen bg-[#FFF2EB]">
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <div className="space-y-6">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Selecting the right design partner is the foundation of creating spaces that are not only beautiful but also purposeful and inspiring. At Vasterior, we go beyond traditional design to deliver experiences that merge functionality, elegance, and innovation. Every project is driven by creativity, precision, and personalization—ensuring that the final result reflects both beauty and individuality.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed">
      ...
      <section className="bg-[#f7d9bc] py-12">
        <div className="max-w-5xl mx-auto px-6">
          <h3 className="text-3xl font-serif text-gray-800 mb-8 text-center">Why Clients Trust Vasterior</h3>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="bg-[#FFF2EB] rounded-2xl p-8 shadow-sm">
            <p className="text-xl font-serif text-gray-800 italic leading-relaxed">
              At Vasterior, we don&apos;t just design spaces—we craft experiences that inspire and endure. Our promise is to create environments that are elegant yet functional, timeless yet innovative, and always a reflection of you.
            </p>
          </div>
        </div>
      </section>
