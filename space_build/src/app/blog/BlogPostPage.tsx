        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-7xl mx-auto">
            <p className="text-gray-700 text-lg leading-relaxed font-light">
              Welcome to our blog, where we share insights, tips, and stories about interior design, architecture, and the latest trends in creating beautiful and functional spaces. Explore our articles to discover inspiration for your next project.
            </p>
          </div>
        </div>
