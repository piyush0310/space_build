        ...
        <div className="w-full lg:w-[60%] px-4 sm:px-8 py-0">
          <div className="space-y-8 text-gray-700">
            <h2 className="mt-6 text-2xl sm:text-3xl font-semibold text-gray-900">
              Vastu Remedies for Marital Problems: A Complete Guide by Space Build Moradabad
            </h2>
            ...
            <div className="space-y-6 mt-6">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">2. Should mirrors be placed in the bedroom?</h3>
                <p>
                  Mirrors should never face the bed directly. If a mirror faces the bed, either reposition it or cover it with a cloth during nighttime hours.
                </p>
              </div>
