      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Searching for the{" "}
            <strong>best Vastu Consultant near you in Moradabad?</strong>{" "}
            Space Build offers trusted Vastu consultation services for homes,
            offices, shops, apartments, factories, plots, and commercial
            properties.
            <br />
            Our experienced Vastu consultants provide practical, personalized,
            and authentic Vastu solutions to improve positivity, prosperity,
            health, success, and overall harmony in your living and working
            spaces.
          </p>
