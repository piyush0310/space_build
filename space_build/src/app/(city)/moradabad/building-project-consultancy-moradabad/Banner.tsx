...
export default function BuildingProjectConsultancyMoradabad() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl max-w-4xl mx-auto leading-relaxed mb-8">
            Looking for professional <strong>Building Project Consultancy in Moradabad</strong>?
            Space Build offers expert consultancy services for residential,
            commercial, industrial, and institutional building projects. From
            project planning and feasibility analysis to budgeting, contractor
            coordination, quality control, and project execution, our team
            ensures smooth project delivery while maintaining high standards of
