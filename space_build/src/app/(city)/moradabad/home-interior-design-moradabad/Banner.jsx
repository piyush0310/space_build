...
export default function HomeInteriorDesignMoradabad() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
            Best Home Interior Design in Moradabad
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Turn your dream home into reality with{" "}
            <strong>Space Build's Home Interior Design Services in Moradabad</strong>.
            <br />
            We create elegant, modern, and functional interiors for houses,
            villas, apartments, and luxury residences. From living rooms and
            bedrooms to modular kitchens and complete home makeovers, our expert
            designers deliver personalized interiors that combine comfort,
