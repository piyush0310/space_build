...
export default function ConstructionManagementCompanyMoradabad() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl max-w-4xl mx-auto leading-relaxed mb-8">
            Looking for a trusted <strong>Construction Management Company in Moradabad</strong>?
            Space Build provides comprehensive construction management services
            for residential, commercial, industrial, and institutional projects.
            Our team oversees planning, budgeting, scheduling, contractor
            coordination, quality control, and site execution to ensure every
            project is completed efficiently, within budget, and to the highest
