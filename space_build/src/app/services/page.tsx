...
export const metadata: Metadata = {
  title: "Luxury Vastu & Interior Design Services | Vasterior Studio",
  description:
    "Explore Vasterior’s luxury MahaVastu, AstroVastu, Interior Design, Vastu Renovation & Styling services, crafted for harmony, beauty & balance.",
  keywords: [
  ...
  // ✅ Canonical
  alternates: {
    canonical: "https://vasterior.com/services",
  },
  ...
  openGraph: {
    ...
    description:
      "Explore Vasterior’s luxury MahaVastu, AstroVastu, Interior Design, Vastu Renovation & Styling services, crafted for harmony, beauty & balance.",
    url: "https://vasterior.com/services",
    siteName: "Vasterior",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Vasterior – Interior Design Services | Residential & Commercial Solutions",
      },
    ],
    locale: "en_US",
    type: "website",
