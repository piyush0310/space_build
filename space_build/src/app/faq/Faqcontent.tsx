...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes. For clients unable to meet in person, we offer online consultations through video calls, digital layouts, and virtual design presentations. This makes it convenient to work with us from anywhere. To book a session, simply contact us via spacebuild.india@gmail.com or +919927611780."
    },
    {
      question: "What is your pricing structure?",
      answer: "Our pricing is project-specific and depends on the services required, scale of work, and material choices. We share a transparent quotation after the initial consultation to ensure clarity for both premium and budget-conscious clients. For inquiries, connect with us at spacebuild.india@gmail.com or +919927611780."
    }
  ];
