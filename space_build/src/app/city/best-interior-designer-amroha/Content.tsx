        ...
        <div className="flex-1 px-4 sm:px-8 md:px-16 py-12 order-1 lg:order-1">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed max-w-4xl">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-900">
              The New Language of Luxury Interiors in Amroha
            </h3>
            <p>
            ...
            <div className="space-y-6">
              <div>
                <h4 className="font-semibold text-gray-900 mb-3">1. Editorial-Caliber Design Sensibility</h4>
                <p>Our approach mirrors the sophistication of international design journals — Architectural Digest, Vogue Living, and Kinfolk.</p>
                <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                  <li>intentional lighting layers</li>
                  <li>sculpted silhouettes</li>
                  <li>serene colour fields</li>
                  <li>meaningful contrasts</li>
                </ul>
                <p className="mt-2">Nothing is loud. Nothing is unnecessary. Everything is quietly powerful.</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2">This creates spaces that nurture clarity, stability, communication, and emotional warmth.</p>
              </div>

              <div>
                <h4 className="font-semibold text-gray-900 mb-3">3. A Deeply Collaborative Design Process</h4>
                <p>Your story becomes the blueprint. Your habits shape the layout. Your aspirations define the material palette. Your lifestyle guides the energy alignment.</p>
                <p>The outcome is a home that is unmistakably you, supported by our design mastery.</p>
              </div>
            </div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <li>Material & finish curation (stones, veneers, leather, fabrics)</li>
              <li>Lighting design & mood layering</li>
              <li>Custom furniture detailing</li>
              <li>Wall elevations, technical drawings, and execution detailing</li>
              <li>Colour palette design</li>
              <li>Interior styling & decor curation</li>
              <li>Bespoke storage & space optimisation</li>
            </ul>
            <p>Each project is created with visual harmony, tactile richness, and long-term durability in mind.</p>
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-900">1. Design That Breathes</h4>
                <p>Spaces are not cluttered; they are curated. Every corner feels intentional. Every surface has purpose. Every texture has meaning.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>Italian and rainforest stones</li>
                  <li>walnut & sheesham woods</li>
                  <li>textured leather</li>
                  <li>metallic accents</li>
                  <li>ceramic art</li>
                  <li>ivory-tinted laminates and veneers</li>
                </ul>
                <p>These materials age beautifully and carry a sense of quiet opulence.</p>
              </div>
            </div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <li>Aligning each room with its most supportive activity</li>
              <li>Enhancing directions with balanced elemental cues</li>
              <li>Integrating colours that uplift emotional and functional tone</li>
            </ul>
            <p>Your space becomes aligned and visually luxurious — not ritualistic or fear-driven.</p>
            ...
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li><strong>Step 2 — Spatial Flow & MahaVastu Mapping</strong> – We study your layout through the lens of activity zones, natural light, and elemental balance.</li>
              <li><strong>Step 3 — Concept Design & Mood Boards</strong> – Rich palettes, material combinations, and conceptual sketches set the tone for the transformation.</li>
              <li><strong>Step 4 — Technical Drawings & 3D Visualization</strong> – Precision-driven drawings ensure clarity, workmanship, and perfect execution.</li>
              <li><strong>Step 5 — Site Execution & Craftsmanship</strong> – Our curated team manages vendors, contractors, quality control, and finishes — ensuring excellence at every stage.</li>
              <li><strong>Step 6 — Styling & Final Reveal</strong> – Accessories, textiles, artwork, lighting, and subtle energy-alignment details bring the space to life.</li>
            </ol>
