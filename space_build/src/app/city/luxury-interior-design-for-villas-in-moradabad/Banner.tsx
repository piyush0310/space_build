...
// Banner 5: Luxury Interior Design For Villas In Moradabad (Alternative)
export default function LuxuryVillaDesignBanner() {
  return (
      ...
      <div className="relative z-20 flex items-center justify-center h-full">
        <div className="text-center text-white px-4">
          <h1 className="text-3xl md:text-5xl font-serif font-light text-black tracking-widest">
            Luxury Interior Design For Villas In Moradabad
          </h1>
        </div>
      </div>
    </section>
