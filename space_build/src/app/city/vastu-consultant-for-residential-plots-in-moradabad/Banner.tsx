// File: vastu-for-business-in-noida-extension/Banner.tsx
    ...
    <section className="relative w-full h-[300px] sm:h-[400px] md:h-[400px] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Vastu Constultant For Residential Plots In Moradabad"
          fill
          priority
      ...
      <div className="relative z-20 flex items-center justify-center h-full">
        <div className="text-center text-white px-4">
          <h1 className="text-3xl md:text-5xl font-serif font-light text-black tracking-widest">
            Vastu Constultant For Residential Plots In Moradabad
          </h1>
        </div>
      </div>
    </section>
