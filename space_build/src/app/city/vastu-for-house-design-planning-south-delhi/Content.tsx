      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="flex-1 px-4 sm:px-8 md:px-16 py-12 order-1 lg:order-1">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed max-w-4xl">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-900">
              Vasterior&apos;s Approach: Interior Design That Is Beautiful and Structurally Supportive
            </h3>
            <p>
            ...
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li>
                ...
                matters most. Work is done with what is possible, including entry flow, bedroom
              ...
              <li>
                ...
                work focus. If you do not have plans, guidance is provided on the next step.
              </li>
              <li>
                <span className="font-semibold">Do you also handle execution?</span>{" "}
                Yes, execution can be included for full-scope projects. For some clients, there is
                also consultation-only planning where your contractor executes under guidance,
              ...
              <li>
                ...
                practically. Belief is not required, only the willingness to design with
                intelligence.
              </li>
              <li>
