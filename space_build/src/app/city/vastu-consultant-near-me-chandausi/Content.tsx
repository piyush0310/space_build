        ...
        <div className="flex-1 px-4 sm:px-8 md:px-16 py-12 order-1 lg:order-1">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed max-w-4xl">
            ...
            <div>
              ...
              <p className="mt-4">
                You can reach out directly by calling <a href="tel:+917906086899" className="text-blue-600 hover:underline">+917906086899</a> for a conversation, or if you prefer writing things down, an email to <a href="mailto:info@spacebuild.com" className="text-blue-600 hover:underline">info@spacebuild.com</a>, is always a good place to start.
              </p>
            ...
            <div>
              ...
              <div className="space-y-6 mt-6">
                ...
                <div>
                  ...
                  <p>Start with a conversation. A quick call on <a href="tel:+917906086899" className="text-blue-600 hover:underline">+917906086899</a> or an email to <a href="mailto:info@spacebuild.com" className="text-blue-600 hover:underline">info@spacebuild.com</a> helps us understand your space and guide you on the best next step.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 p-8 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl shadow-lg border border-orange-100">
              ...
              <div className="text-center space-y-3">
                ...
                <p>📧 Email: <a href="mailto:info@spacebuild.com" className="text-blue-600 hover:underline font-semibold">info@spacebuild.com</a></p>
              </div>
            </div>
          </div>
