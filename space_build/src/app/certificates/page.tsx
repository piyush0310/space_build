...
export const metadata: Metadata = {
  ...
  keywords:
    "mahavastu certificate, vastu certification india, MahaVastu Acharya Chitresh Jain certificate, khushdeep bansal mahavastu, vastu consultant certification, vastu expert india, Space Build certificates",
