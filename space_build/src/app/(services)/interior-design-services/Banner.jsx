      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Transform your home, office, or commercial space with Space Build's{" "}
            <strong>Interior Design Services</strong>.
            <br />
            We create stylish, functional, and customized interiors that reflect
            your vision and enhance everyday living.
          </p>
