      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Transform your kitchen with Space Build's{" "}
            <strong>Luxury Modular Kitchen</strong> services.
            <br />
            We create stylish, functional, and customized kitchens with smart
            layouts, premium finishes, and efficient storage solutions.
          </p>
          {/* CTA Buttons */}
