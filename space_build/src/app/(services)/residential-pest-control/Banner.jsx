      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Protect your home with Space Build's{" "}
            <strong>Residential Pest Control</strong> services.
            <br />
            We provide safe, effective, and long-lasting pest control solutions
            to eliminate termites, cockroaches, rodents, ants, mosquitoes, and
            other unwanted pests, ensuring a clean, hygienic, and healthy living
