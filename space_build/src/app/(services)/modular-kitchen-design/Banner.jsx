...
export default function LuxuryModularKitchen() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Elevate your cooking experience with Space Build's{" "}
            <strong>Modular Kitchen Design</strong> solutions.
            <br />
            We design elegant, space-efficient, and fully customized kitchens
            with premium finishes, smart storage, and modern functionality.
          </p>
                    {/* CTA Buttons */}
