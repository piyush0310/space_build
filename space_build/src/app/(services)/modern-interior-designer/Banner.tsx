...
export default function ModernInteriorDesigner() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Transform your home or office with Space Build's{" "}
            <strong>Modern Interior Designer</strong> services, creating elegant,
            functional, and luxurious interiors tailored to your lifestyle.
            <br />
            From innovative designs to flawless execution, we deliver spaces
            that blend beauty, comfort, and lasting quality.
          </p>
