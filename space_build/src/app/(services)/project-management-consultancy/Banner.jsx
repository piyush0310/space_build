      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Achieve successful project outcomes with Space Build's{" "}
            <strong>Project Management Consultancy</strong>.
            <br />
            We provide expert planning, coordination, budgeting, and execution
            strategies to ensure every project is delivered on time and within budget.
          </p>
