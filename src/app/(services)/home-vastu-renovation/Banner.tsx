...
export default function HomeVastuRenovation() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
            Home Vastu Renovation
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Upgrade your home with Space Build's{" "}
            <strong>Home Vastu Renovation</strong> services.
            <br />
            We renovate existing spaces using Vastu principles to improve
            harmony, functionality, and positive energy without compromising
            modern design.
          </p>
