...
export default function ConstructionManagementServices() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Build with confidence through Space Build's{" "}
            <strong>Construction Management Services</strong>.
            <br />
            We manage planning, quality, timelines, and execution to ensure your
            project is completed efficiently, on budget, and to the highest standards.
          </p>
