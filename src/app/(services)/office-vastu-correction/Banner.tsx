...
export default function OfficeVastuCorrection() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
            Office Vastu Correction
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Optimize your workplace with Space Build's{" "}
            <strong>Office Vastu Correction</strong> services.
            <br />
            We improve office layouts using Vastu principles to enhance
            productivity, success, positive energy, and overall business growth.
          </p>
