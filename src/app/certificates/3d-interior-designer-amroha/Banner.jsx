      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
           3D Interior Designer Amroha
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6">
           Space Build empowers businesses in Amroha with innovative interior design, architecture, and MahaVastu solutions. We create functional, elegant, and Vastu-compliant spaces that reflect your vision while enhancing comfort, style, and long-term value.
          </p>
