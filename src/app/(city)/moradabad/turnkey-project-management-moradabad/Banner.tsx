...
export default function TurnkeyProjectManagementMoradabad() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl max-w-4xl mx-auto leading-relaxed mb-8">
            Looking for professional <strong>Turnkey Project Management in Moradabad</strong>?
            Space Build offers complete turnkey project management solutions for
            residential, commercial, office, retail, and industrial projects.
            From concept planning and design coordination to procurement,
            construction supervision, quality assurance, and final handover, we
            manage every aspect of your project, ensuring a hassle-free
            experience, timely completion, and superior quality results.
          </p>
