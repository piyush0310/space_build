      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
            Best Interior Designer in Moradabad
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Design your dream space with{" "}
            <strong>Space Build's Best Interior Designers in Moradabad</strong>.
            <br />
            We specialize in creating modern, luxurious, and functional
            interiors for homes, villas, apartments, offices, shops,
            restaurants, and commercial spaces. Our customized interior
            solutions combine creativity, premium materials, and expert
            craftsmanship to deliver beautiful spaces that perfectly match your
