...
export default function BestPestControlMoradabad() {
  return (
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
            Best Pest Control in Moradabad
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Looking for the <strong>Best Pest Control in Moradabad</strong>?
            Space Build provides reliable, safe, and affordable pest control
            ...
            bug removal, ant control, and complete pest management services.
            We use eco-friendly, government-approved products and advanced
            treatment methods to provide effective and long-lasting protection
