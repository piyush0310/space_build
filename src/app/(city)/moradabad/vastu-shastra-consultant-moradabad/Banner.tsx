      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-serif mb-4 mt-18 md:mt-30">
            Best Vastu Shastra Consultant in Moradabad
          </h1>

          {/* Subheading */}
          <p className="text-xl mb-6 max-w-4xl mx-auto">
            Discover the benefits of authentic{" "}
            <strong>Vastu Shastra Consultation in Moradabad</strong> with Space
            Build.
            <br />
            Our experienced Vastu Shastra consultants provide personalized
            guidance for homes, offices, shops, factories, apartments, plots,
            and commercial properties to improve positivity, harmony,
            prosperity, health, and long-term success using traditional Vastu
            principles.
          </p>
